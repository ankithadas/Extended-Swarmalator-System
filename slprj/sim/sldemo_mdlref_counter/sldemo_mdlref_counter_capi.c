...
#endif
#ifndef HOST_CAPI_BUILD
static void sldemo_mdlref_counter_InitializeLoggingFunctions (
...
rtDimensionArray } , "float" , { 2016961625U , 1179118972U , 2971095994U ,
745439214U } , & mmiStaticInfoLogging , 0 , 0 } ; const
...
sldemo_mdlref_counter_InitializeLoggingFunctions ( ilxj1cme0p -> DataMapInfo
. loggingPtrs ) ; rtwCAPI_SetLoggingPtrs ( ilxj1cme0p -> DataMapInfo . mmi ,
ilxj1cme0p -> DataMapInfo . loggingPtrs ) ; rtwCAPI_SetInstanceLoggingInfo (
ilxj1cme0p -> DataMapInfo . mmi , & ilxj1cme0p -> DataMapInfo .
mmiLogInstanceInfo ) ; rtwCAPI_SetChildMMIArray ( ilxj1cme0p -> DataMapInfo .
mmi , ( NULL ) ) ; rtwCAPI_SetChildMMIArrayLen ( ilxj1cme0p -> DataMapInfo .
mmi , 0 ) ; sldemo_mdlref_counter_InitializeSystemRan ( ilxj1cme0p ,
ilxj1cme0p -> DataMapInfo . systemRan , localDW , ilxj1cme0p -> DataMapInfo .
systemTid , sysRanPtr , contextTid ) ; rtwCAPI_SetSystemRan ( ilxj1cme0p ->
DataMapInfo . mmi , ilxj1cme0p -> DataMapInfo . systemRan ) ;
rtwCAPI_SetSystemTid ( ilxj1cme0p -> DataMapInfo . mmi , ilxj1cme0p ->
DataMapInfo . systemTid ) ; rtwCAPI_SetGlobalTIDMap ( ilxj1cme0p ->
DataMapInfo . mmi , & ilxj1cme0p -> Timing . mdlref_GlobalTID [ 0 ] ) ; }
#else
#ifdef __cplusplus
extern "C" {
#endif
